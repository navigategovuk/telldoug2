    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.description}>
          Upload your LinkedIn export to bring in roles, education, skills, connections, and more.
        </p>
        <p className={styles.description}>
          ZIP exports give the most complete import. CSV works well for one-off updates.
        </p>
      </div>
        ...
        {selectedFile ? (
          ...
          <>
            ...
            <p className={styles.dropText}>
              Drag and drop your LinkedIn ZIP or CSV export
            </p>
        ...
        <label className={styles.optionLabel}>
          ...
          <span className={styles.optionText}>
            ...
            <span className={styles.optionDescription}>
              Skip review and import using recommended defaults
            </span>
          </span>
        </label>
      </div>
      ...
      <div className={styles.instructions}>
        ...
        <p className={styles.supportedFormats}>
          <strong>Supported formats:</strong> LinkedIn ZIP export (recommended), CSV files
        </p>
      </div>
    </div>
  );
