...
export function AchievementDialog({ open, onOpenChange, achievement }: AchievementDialogProps) {
  ...
  }, [open, achievement, form.setValues]);
                  ...
                  <PopoverContent removeBackgroundAndPadding align="start">
                    <Calendar
                      ...
                      onSelect={(date: Date | undefined) =>
                        date && form.setValues((prev) => ({ ...prev, achievedDate: date }))
                      }
                    />
                  </PopoverContent>
                </Popover>
            ...
            <FormItem name="quantifiableImpact">
              ...
              <FormControl>
                <Input
                  ...
                  onChange={(e) =>
                    form.setValues((prev) => ({ ...prev, quantifiableImpact: e.target.value }))
                  }
                />
              </FormControl>
              <FormMessage />
            ...
            <FormItem name="evidenceUrl">
              ...
              <FormControl>
                <Input
                  ...
                  onChange={(e) =>
                    form.setValues((prev) => ({ ...prev, evidenceUrl: e.target.value }))
                  }
                />
              </FormControl>
              <FormMessage />
