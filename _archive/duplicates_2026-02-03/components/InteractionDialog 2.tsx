...
import type { InteractionWithDetails } from "../endpoints/interactions/list_GET.schema";
import type { InteractionType } from "../helpers/schema";
                ...
                <FormControl>
                  <Select
                    ...
                    onValueChange={(value: string) =>
                      setValues((prev) => ({ ...prev, interactionType: value as InteractionType }))
                    }
                  >
                    <SelectTrigger>
                  ...
                  <PopoverContent removeBackgroundAndPadding align="start">
                    <Calendar
                      ...
                      onSelect={(date: Date | undefined) =>
                        date && setValues((prev) => ({ ...prev, interactionDate: date }))
                      }
                    />
                  </PopoverContent>
                </Popover>
