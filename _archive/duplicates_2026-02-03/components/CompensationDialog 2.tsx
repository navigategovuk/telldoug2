...
import type { Compensation } from "../helpers/schema";
                  ...
                  <PopoverContent removeBackgroundAndPadding align="start">
                    <Calendar
                      ...
                      onSelect={(date: Date | undefined) =>
                        date && setValues((prev) => ({ ...prev, effectiveDate: date }))
                      }
                    />
                  </PopoverContent>
                </Popover>
            ...
            <FormItem name="baseSalary">
              ...
              <FormControl>
                <Input
                  ...
                  onChange={(e) =>
                    setValues((prev) => ({ ...prev, baseSalary: Number(e.target.value) }))
                  }
                />
              </FormControl>
              <FormMessage />
              ...
              <FormItem name="bonus">
                ...
                <FormControl>
                  <Input
                    ...
                    onChange={(e) =>
                      setValues((prev) => ({ ...prev, bonus: Number(e.target.value) }))
                    }
                  />
                </FormControl>
                <FormMessage />
              ...
              <FormItem name="equityValue">
                ...
                <FormControl>
                  <Input
                    ...
                    onChange={(e) =>
                      setValues((prev) => ({ ...prev, equityValue: Number(e.target.value) }))
                    }
                  />
                </FormControl>
                <FormMessage />
            ...
            <FormItem name="benefitsNote">
              ...
              <FormControl>
                <Textarea
                  ...
                  onChange={(e) =>
                    setValues((prev) => ({ ...prev, benefitsNote: e.target.value }))
                  }
                />
              </FormControl>
              <FormMessage />
