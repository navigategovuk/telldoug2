...
import { InstitutionTypeArrayValues } from "../helpers/schema";
import { useCreateInstitution, useUpdateInstitution } from "../helpers/useInstitutionsApi";

import type { InstitutionType, Institutions } from "../helpers/schema";
                ...
                <FormControl>
                  <Select
                    ...
                    onValueChange={(value: string) =>
                      setValues((prev) => ({ ...prev, type: value as InstitutionType }))
                    }
                  >
                    <SelectTrigger>
              ...
              <FormItem name="degree">
                ...
                <FormControl>
                  <Input
                    ...
                    onChange={(e) =>
                      setValues((prev) => ({ ...prev, degree: e.target.value }))
                    }
                  />
                </FormControl>
                <FormMessage />
              ...
              <FormItem name="fieldOfStudy">
                ...
                <FormControl>
                  <Input
                    ...
                    onChange={(e) =>
                      setValues((prev) => ({ ...prev, fieldOfStudy: e.target.value }))
                    }
                  />
                </FormControl>
                <FormMessage />
                ...
                <Popover>
                  ...
                  <PopoverContent removeBackgroundAndPadding align="start">
                    <Calendar
                      ...
                      onSelect={(date: Date | undefined) =>
                        setValues((prev) => ({ ...prev, endDate: date }))
                      }
                    />
                  </PopoverContent>
                </Popover>
