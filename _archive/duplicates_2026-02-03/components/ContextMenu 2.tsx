...
>(({ className, inset, children, ...props }, ref) => (
  <ContextMenuPrimitive.SubTrigger
    ref={ref}
    className={`${styles.subTrigger} ${className ?? ""} ${inset ? styles.inset : ""}`}
    {...props}
  >
    {children}
...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ref={ref}
    className={`${styles.item} ${className ?? ""} ${inset ? styles.inset : ""}`}
    {...props}
  />
))
...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Label
    ref={ref}
    className={`${styles.label} ${className ?? ""} ${inset ? styles.inset : ""}`}
    {...props}
  />
))
