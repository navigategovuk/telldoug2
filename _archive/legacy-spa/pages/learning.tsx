...
import type { Learning, LearningType, LearningStatus} from "../helpers/schema";
...
export default function LearningPage() {
  ...
  const handleTypeFilterChange = (value: string) => {
    setTypeFilter(value as LearningType | "all");
  };

  const handleStatusFilterChange = (value: string) => {
    setStatusFilter(value as LearningStatus | "all");
  };
