                ...
                <FormControl>
                  <Select
                    ...
                    onValueChange={(val: any) =>
                      form.setValues((prev) => ({ ...prev, contentType: val }))
                    }
                  >
                    <SelectTrigger>
              ...
              <FormItem name="publicationDate">
                ...
                <FormControl>
                  <Input
                    ...
                    onChange={(e) =>
                      form.setValues((prev) => ({ ...prev, publicationDate: e.target.value }))
                    }
                  />
                </FormControl>
                <FormMessage />
            ...
            <FormItem name="platform">
              ...
              <FormControl>
                <Input
                  ...
                  onChange={(e) =>
                    form.setValues((prev) => ({ ...prev, platform: e.target.value }))
                  }
                />
              </FormControl>
              <FormMessage />
            ...
            <FormItem name="url">
              ...
              <FormControl>
                <Input
                  ...
                  onChange={(e) =>
                    form.setValues((prev) => ({ ...prev, url: e.target.value }))
                  }
                />
              </FormControl>
              <FormMessage />
            ...
            <FormItem name="engagementMetrics">
              ...
              <FormControl>
                <Input
                  ...
                  onChange={(e) =>
                    form.setValues((prev) => ({ ...prev, engagementMetrics: e.target.value }))
                  }
                />
              </FormControl>
              <FormMessage />
