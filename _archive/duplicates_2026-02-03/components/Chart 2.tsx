                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    {itemConfig?.icon ? (
                      ...
                      !hideIndicator && (
                        <div
                          className={`${styles.tooltipItemIndicator} ${styles["tooltipItemIndicator-" + (nestLabel && indicator === "dashed" ? "nested-dashed" : indicator)]}`} // dot, line, dashed
                          style={
                            {
                    ...
                    <div
                      className={`${styles.tooltipItemLabel} ${nestLabel ? styles["tooltipItemLabel-nested"] : styles["tooltipItemLabel-center"]}`}
                    >
                      <div className={styles.tooltipItemLabelContent}>
                        {nestLabel ? tooltipLabel : null}
                        <span className={styles.tooltipItemLabelText}>
