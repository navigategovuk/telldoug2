...
export default function FeedbackPage() {
  const [feedbackType, setFeedbackType] = useState<FeedbackType | "_all">("_all");
  const [personId, setPersonId] = useState<string>("_all");
  
  const handleFeedbackTypeChange = (value: string) => {
    setFeedbackType(value as FeedbackType | "_all");
  };

  const { data, isLoading } = useFeedbackList({
    feedbackType: feedbackType === "_all" ? undefined : feedbackType,
